...
app.use('/api/economia-operaciones', require('./routes/EconomiaOperacion.routes'));
app.use('/api/certificados-cliente', require('./routes/CertificadoCliente.routes'));
app.use('/api/certificados-responsable', require('./routes/CertificadoResponsable.routes'));
app.use('/api/movimientos-financieros', require('./routes/MovimientoFinanciero.routes'));
